...
import { getPayPalConfig } from "../../services/APIFunctions";
...
const PayPalPayment = ({
  ...
  const [currentAmount, setCurrentAmount] = useState(
    defaultCurrency === "USD" ? amount : amountMXN
  );
        ...
        <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
          <button
            ...
            style={{
              ...
              borderRadius: "8px",
              backgroundColor:
                selectedCurrency === "USD" ? "#eaf4fb" : "#ffffff",
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "8px",
              backgroundColor:
                selectedCurrency === "MXN" ? "#eaf4fb" : "#ffffff",
